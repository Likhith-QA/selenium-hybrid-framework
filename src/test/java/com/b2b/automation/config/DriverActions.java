package com.b2b.automation.config;

import com.b2b.automation.execution.TestRunner;
import com.b2b.automation.helpers.*;
import com.b2b.automation.utility.Log;
...
import static com.b2b.automation.execution.TestRunner.OR;
...
public class DriverActions {
    ...
    public static void click(String object, String locator, String data) throws IOException {
        try {
            ...
            wait.untilElementIsClickable(Elements.getElement(locator, OR.getString(object)));
    ...
    public static void inputAndEnter(String object, String locator, String data) throws IOException {
        try {
            ...
            Elements.getElement(locator, OR.getString(object)).sendKeys(data);
            wait.impWait(10);
            Elements.getElement(locator, OR.getString(object)).sendKeys(Keys.ENTER);
    ...
    public static void selectByVisibleText(String object, String locator, String data) throws IOException {
        try {
            Select select = new Select(Elements.getElement(locator, OR.getString(object)));
    ...
    public static void assertAllResultsHaveHQIcon(String object, String locator, String data) throws IOException {
        int amountOfResults = Elements.getElements(locator, OR.getString(object)).size();
        try {
    ...
    public static void assertNoResults(String object, String locator, String data) throws IOException {
        try {
            String strResultMsg = Elements.getElement(locator, OR.getString(object)).getText();
